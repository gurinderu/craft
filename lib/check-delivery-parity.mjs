...
// two engines that read these verdicts — the `ok` row is confirmed by recognition, through
// `hasVerdictLine`, and the other three rows by the returned token, through `parseVerdict`, both in
