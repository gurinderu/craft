...
// check-delivery-parity.test.mjs only proves the TABLE→ENGINE direction — every word claimed here is
// read by the parser as claimed. Nothing proves the ENGINE→TABLE direction: a fifth verdict added to
// `RANK` in opencode/plugin/run-record.mjs would fall outside this gate entirely, with every test
// here still green. Accepted, not implemented.
