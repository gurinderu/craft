...
export const LEDGER_COPY_REFUSAL_ENTRIES = 170
...
export const LEDGER_COPY_SAFETY_ROWS = 20
...
export const LEDGER_TOMBSTONE_MAX = LEDGER_COPY_REFUSAL_ENTRIES - LEDGER_COPY_SAFETY_ROWS
...
export function tombstoneRound(t) {
...
export function pruneTombstones(tombstones, { max = LEDGER_TOMBSTONE_MAX } = {}) {
...
export function tombstoneBudget(liveCount, { ceiling = LEDGER_TOMBSTONE_MAX } = {}) {
