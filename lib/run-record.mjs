...
// functions. Keep the copies in workflows/review.js (the elastic engine — mirrors the round-aware
// ledger helpers too) and workflows/rust-audit.js in sync.
...
// Newest single prior round, or null.
export function selectPriorRound(indexEntries, { project, branch }) {
  return selectPriorRounds(indexEntries, { project, branch })[0] ?? null
}
