...
function loadHelpers() {
  ...
  const factory = new Function(
    ...
    `${prefix}\n;return { PROFILES, supportedLangLabel, resolveProfilePin, unknownPinMessage, noLanguageMessage, nothingToReviewMessage, materialUncovered, uncoveredNotRunNote };`,
  )
...
test('the no-profile early return uses materialUncovered, and only the inert case is green', () => {
  ...
  assert.ok(
    src.includes('if (changedFiles.length && !noProfileMaterial.length) {'),
