...
export const PRIOR_SUMMARY_MAX_CHARS = 3000
export const PRIOR_SUMMARY_TITLE_MAX = 120
export function priorFoundSummary(pool, { maxChars = PRIOR_SUMMARY_MAX_CHARS, titleMax = PRIOR_SUMMARY_TITLE_MAX } = {}) {
