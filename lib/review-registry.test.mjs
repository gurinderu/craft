...
test('adjudicate track: schema forces the invariant→attack method; red-team is wired', () => {
  ...
  assert.deepEqual(
    ADJUDICATE_SCHEMA.properties.status.enum, ['resolved', 'still-open', 'regressed'],
    'ADJUDICATE_SCHEMA.status enum drifted — the checkResults loop in review.js hard-codes these three values',
  )
})
