...
test('re-review wiring: new findings matching a still-live prior are absorbed, resolved priors excepted', () => {
  ...
  assert.ok(src.includes('markTrackedUnverified(unverified, livePriors, retired, matchesPrior)'), 'and the unverified track is marked in place, never absorbed into a host it would then hold open')
