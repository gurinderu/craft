...
import { EVIDENCE_MARKER, GREEN_DIMENSION_VERDICTS, hasEvidence, demoteUnsupportedGreen } from './audit-evidence.mjs'
import { EVIDENCE } from './check-delivery-parity.mjs'
import { unusedCratesResult, wrapVerdict } from './audit-verification.mjs'
...
test('a green verdict with no evidence is demoted to INCOMPLETE, keeping the claimed word', () => {
  for (const verdict of GREEN_DIMENSION_VERDICTS) {
