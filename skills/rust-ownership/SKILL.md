---
name: rust-ownership
description: Rust ownership, borrowing, lifetimes, and smart pointers — the mental model plus concrete fixes for borrow-checker errors. Use when fighting the borrow checker, deciding whether to take T / &T / &mut T, choosing Box/Rc/RefCell/Cow, returning references, or resolving move/borrow/lifetime errors. Triggers: borrow checker, ownership, move, moved value, borrowed, lifetime, 'a, 'static, &mut, cannot borrow, does not live long enough, Box, Rc, Arc, RefCell, Cow, E0382, E0499, E0502, E0505, E0507, E0515, E0597, E0106, E0716.
---
