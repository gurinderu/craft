---
name: rust-macros
description: Rust metaprogramming — declarative macros (macro_rules!) and procedural macros (derive, attribute, function-like) with syn/quote, plus when a macro is the wrong tool. Use when writing or debugging a macro, generating boilerplate, building a derive, or deciding macro vs generics. Triggers: macro, macro_rules!, declarative macro, procedural macro, proc macro, derive macro, attribute macro, syn, quote, metaprogramming, cargo expand, ToTokens, custom derive, DSL.
---
